...
var Git = (function () {
    ...
    Git.prototype.init = function (dir) {
        var isBare = 0;
        var repo;
        var index;
        var oid;
        ...
        nodegit.Repository.init(os.homedir() + '/' + dir, isBare).then(function (repo) {
            nodegit.Repository.open(path.resolve(os.homedir(), dir))
                ...
                var author = nodegit.Signature.create('richie', 'beastar457@gmail.com', 123456789, 60);
                var committer = nodegit.Signature.create('richie', 'beastar457@gmail.com', 987654321, 90);
